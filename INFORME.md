...
Para manejar el procesamiento concurrente de las conexiones y el cálculo del sorteo condicionado al quórum de agencias, se optó por un enfoque de **estado compartido mediante Locks y Barriers**.
...
### Cliente
* **Goroutine dedicada y Channels:** Se implementó un enfoque basado en canales de Go. Una goroutine en segundo plano bloquea la ejecución escuchando el canal `os.Signal`.
